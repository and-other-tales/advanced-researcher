...
# Web service
resource "google_cloud_run_v2_service" "advanced_researcher_backend" {
  name     = var.advanced_researcher_backend_name
  location = var.region
...
resource "google_cloud_run_v2_service_iam_policy" "web_noauth" {
  location    = google_cloud_run_v2_service.advanced_researcher_backend.location
  project     = google_cloud_run_v2_service.advanced_researcher_backend.project
  name        = google_cloud_run_v2_service.advanced_researcher_backend.name
...
resource "google_compute_region_network_endpoint_group" "web_serverless_neg" {
  ...
  region                = var.region
  cloud_run {
    service = google_cloud_run_v2_service.advanced_researcher_backend.name
  }
}
