    ...
    <div className="flex flex-col items-center p-8 rounded grow max-h-full">
            ...
            <div className="shrink-0 flex items-center">
              <input
                ...
                onChange={(e) => {
                  ...
                  insertUrlParam("advanced_verification", newValue.toString());
                  setAdvancedVerification(newValue);
                }}
              ...
              />
              <label
                htmlFor="advanced-verification"
                className="flex items-center cursor-pointer text-sm font-medium text-white"
              >
                Advanced Verification
                <span className="ml-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-gradient-to-r from-blue-700 to-indigo-800 rounded-full">BETA</span>
              </label>
            </div>
          </div>
      ...
      {messages.length === 0 ? (
        <footer className="flex justify-center absolute bottom-8">
          <a
            href="https://github.com/and-other-tales/advanced-researcher"
            target="_blank"
